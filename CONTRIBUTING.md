...
## [Code of Conduct](https://github.com/virtomize/mail2most/blob/master/CODE_OF_CONDUCT.md)

The Mail2Most project follows the [Contributor Covenant Code of Conduct](https://github.com/virtomize/mail2most/blob/master/CODE_OF_CONDUCT.md)
...
- By opening an issue for discussion: For example, if you found a bug, creating a bug report using the [template](https://github.com/virtomize/mail2most/blob/master/.github/ISSUE_TEMPLATE/bug_report.md) is the way to report it.
- By providing supporting details to an existing issue: For example, additional testcases.
- By helping to resolve an issue: For example by opening a [Pull Request](https://github.com/virtomize/mail2most/pulls)

### Asking for Help

Just open a [regular issue](https://github.com/virtomize/mail2most/issues/new) and describe your problem.
...
Fork the project [on Github](https://github.com/virtomize/mail2most/) and clone your fork

```
$ git clone git@github.com:username/mail2most.git
$ cd mail2most
$ git remote add upstream https://github.com/virtomize/mail2most.git
$ git feth upstream
```
...
If your commits are ready to go and passed all tests and linting, you can start creating a [Pull Requests](https://github.com/virtomize/mail2most/pulls) by pushing your work branch to your fork on GitHub.
...
Also follow the [Code of Conduct](https://github.com/virtomize/mail2most/blob/master/CODE_OF_CONDUCT.md)
